...
+
. Configure the following fields: Role Binding Name: *view*, Namespace: *{ocp4_starter_project}*, Role Name: *view*, Subject: *Service Account*, Subject Namespace: *{ocp4_starter_project}*, Subject Name: *default*.
+
