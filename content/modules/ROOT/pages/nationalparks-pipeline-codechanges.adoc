...
If you prefer link to open it in a new browser tab:{ocp4_starter_gitea_url}/{ocp4_starter_gitea_user}/nationalparks[Gitea Repository,window='_blank']
...
Paste your link into the "Target URL" field.
