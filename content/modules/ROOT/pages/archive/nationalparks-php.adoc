...
link:http://gogs-%INFRA_PROJECT%.{ocp4_starter_apps_domain}/{ocp4_starter_username}/nationalparks.git[Gogs Repository]
...
In the OpenShift web console, find your `{ocp4_starter_project}` project, and then
...
----
http://gogs-%INFRA_PROJECT%.{ocp4_starter_apps_domain}/{ocp4_starter_username}/nationalparks-php.git
----
...
nationalparks   nationalparks-{ocp4_starter_project}.{ocp4_starter_apps_domain}             nationalparks   8080-tcp
parksmap        parksmap-{ocp4_starter_project}.{ocp4_starter_apps_domain}                  parksmap        8080-tcp
----
...
----
http://nationalparks-{ocp4_starter_project}.{ocp4_starter_apps_domain}
----
