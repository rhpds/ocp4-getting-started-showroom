...
In the Developer Perspective in your `{ocp4_starter_project}` project,
...
----
http://nationalparks-{ocp4_starter_project}.{ocp4_starter_apps_domain}/ws/data/all
----
...
[source,bash,role=copypaste,subs="+attributes,macros+"]
----
http://nationalparks-{ocp4_starter_project}.{ocp4_starter_apps_domain}/ws/data/load
----
...
[source,bash,role=copypaste,subs="+attributes,macros+"]
----
http://parksmap-{ocp4_starter_project}.{ocp4_starter_apps_domain}
----
